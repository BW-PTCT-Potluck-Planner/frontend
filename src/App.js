...
import { Guests, GuestInvite } from 'components/guests';
    ...
    <>
      <Router>
        ...
        <Switch>
          ...
          <PrivateRoute exact path="/event/:id/rsvp" to="/login" component={Guests} />
          <PrivateRoute exact path="/event/:id/invite" to="/login" component={GuestInvite} />
